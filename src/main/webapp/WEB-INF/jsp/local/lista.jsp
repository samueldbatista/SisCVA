...
<tags:layout>
    ...
    <jsp:body>
        <tags:header titulo="Locais"/>
        <tags:painel titulo="local.titulo.cadastro" tipo="panel-default">
            <form action="${linkTo[LocalController].salvar}" method="post">
                <div class="form-group">
                    <label for="local">Local:</label>
                    <input id="local" type="text" name="local.local" value="${local.local}" class="form-control input-sm">
                </div>
                <button class="btn btn-primary" style="float: right;" type="submit">Salvar</button>
            </form>
        </tags:painel>

        <tags:painel titulo="local.titulo.lista" tipo="panel-default">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <c:forEach items="${locais}" var="local">
                        <tr>
                            ...
                            <td>${local.local}</td>
                            <td>
                                <a title="Remover" class="btns-remocao" href="#modal-remocao" data-toggle="modal" url-remocao="${linkTo[LocalController].remover}?id=${local.id}" ><i class="fa fa-trash fa-lg"></i></a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>

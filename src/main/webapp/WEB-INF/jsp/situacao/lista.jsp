...
<tags:layout>
    ...
    <jsp:body>
        <tags:header titulo="Situações"/>
        <tags:painel titulo="situacao.titulo.cadastro" tipo="panel-default">
            <form action="${linkTo[SituacaoController].salvar}" method="post">
                <div class="form-group">
                    <label for="situacao">Situacao:</label>
                    <input id="situacao" type="text" name="situacao.situacao" value="${situacao.situacao}" class="form-control input-sm">
                </div>
                <button class="btn btn-primary" style="float: right;" type="submit">Salvar</button>
            </form>
        </tags:painel>

        <tags:painel titulo="situacao.titulo.lista" tipo="panel-default">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <c:forEach items="${situacoes}" var="situacao">
                        <tr>
                            ...
                            <td>
                                <a title="Remover" class="btns-remocao" href="#modal-remocao" data-toggle="modal" url-remocao="${linkTo[SituacaoController].remover}?id=${situacao.id}" ><i class="fa fa-trash fa-lg"></i></a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>

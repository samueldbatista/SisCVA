...
<tags:layout>
    ...
    <jsp:body>
        <tags:header titulo="Cadastro e listagem de delegacias"/>
        <tags:painel titulo="delegacia.titulo.cadastro" tipo="panel-default">
            <form action="${linkTo[DelegaciaController].salvar}" method="post">
                <div class="form-group">
                    <label for="delegacia">Delegacia:</label>
                    <input id="delegacia" type="text" name="delegacia.nome" value="${delegacia.nome}" class="form-control input-sm">
                </div>
                <button class="btn btn-primary" style="float: right;" type="submit">Salvar</button>
            </form>
        </tags:painel>

        <tags:painel titulo="delegacia.titulo.lista" tipo="panel-default">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <c:forEach items="${delegacias}" var="delegacia">
                        <tr>
                            ...
                            <td>
                                <a title="Remover" class="btns-remocao" href="#modal-remocao" data-toggle="modal" url-remocao="${linkTo[DelegaciaController].remover}?id=${delegacia.id}" ><i class="fa fa-trash fa-lg"></i></a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>

...
<tags:layout>
    ...
    <jsp:body>
        <tags:painel titulo="seguro.titulo.cadastro" tipo="panel-default">
            <form action="${linkTo[SeguroController].salvar}" method="post">
                <div class="form-group">
                    <label for="seguro">Seguro:</label>
                    <input id="seguro" type="text" name="seguro.seguro" value="${seguro.seguro}" class="form-control input-sm">
                </div>
                <button class="btn btn-primary" style="float: right;" type="submit">Salvar</button>
            </form>
        </tags:painel>

        <tags:painel titulo="seguro.titulo.lista" tipo="panel-default">
                ...
                <table class="table table-bordered table-striped">
                    ...
                    <c:forEach items="${seguros}" var="seguro">
                        <tr>
                            ...
                            <td>${seguro.seguro}</td>
                            <td>
                                <a title="Remover" class="btns-remocao" href="#modal-remocao" data-toggle="modal" url-remocao="${linkTo[SeguroController].remover}?id=${seguro.id}" ><i class="fa fa-trash fa-lg"></i></a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>

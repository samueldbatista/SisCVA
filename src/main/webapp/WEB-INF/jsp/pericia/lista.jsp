...
<tags:layout>
    ...
    <jsp:body>
        <tags:header titulo="Exames"/>
        <tags:painel titulo="pericia.titulo.cadastro" tipo="panel-default">
            <form action="${linkTo[PericiaController].salvar}" method="post">
                <div class="form-group">
                    <label for="pericia">Pericia:</label>
                    <input id="pericia" type="text" name="pericia.pericia" value="${pericia.pericia}" class="form-control input-sm">
                </div>
                <button class="btn btn-primary" style="float: right;" type="submit">Salvar</button>
            </form>
        </tags:painel>

        <tags:painel titulo="pericia.titulo.lista" tipo="panel-default">
            <div class="tabela-deprov">
                <table class="table table-bordered table-striped">
                    ...
                    <c:forEach items="${pericias}" var="pericia">
                        <tr>
                            <td>${pericia.id}</td>
                            <td>${pericia.pericia}</td>
                            <td>
                                <a title="Remover" class="btns-remocao" href="#modal-remocao" data-toggle="modal" url-remocao="${linkTo[PericiaController].remover}?id=${pericia.id}" ><i class="fa fa-trash fa-lg"></i></a>
                            </td>
                        </tr>
                    </c:forEach>
                    </tbody>
